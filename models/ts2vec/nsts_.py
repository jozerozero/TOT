...
class SamePadConv(nn.Module):
    def __init__(self, args, in_channels, out_channels, kernel_size, dilation=1, groups=1, gamma=0.9):
        super().__init__()
...
class ConvBlock(nn.Module):
    def __init__(self, args, in_channels, out_channels, kernel_size, dilation, final=False, gamma=0.9):
        super().__init__()
        self.conv1 = SamePadConv(args, in_channels, out_channels, kernel_size, dilation=dilation, gamma=gamma)
        self.conv2 = SamePadConv(args, out_channels, out_channels, kernel_size, dilation=dilation, gamma=gamma)
...
class DilatedConvEncoder(nn.Module):
    def __init__(self, args, in_channels, channels, kernel_size, gamma=0.9):
        super().__init__()
