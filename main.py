...
parser.add_argument('--zc_kl_weight', type=float, default=0.000001, help='zc_kl_weight')
parser.add_argument('--obs_weight', type=float, default=0.000001, help='obs_weight')
parser.add_argument('--hidden_layers', type=int, default=2, help='number of hidden layers of en/decoder')
parser.add_argument('--mode', type=str, default='var', help='latent dimension of koopman embedding')
...
parser.add_argument('--weight', type=float, default=0.01, help='num of encoder layers')
# nsts

parser.add_argument('--dropout', type=float, default=0.05, help='dropout')
parser.add_argument('--depth', type=int, default=9, help='depth of TCN')
parser.add_argument('--hidden_dim_enc', type=int, default=512, help='hidden dimension of en/decoder')
parser.add_argument('--hidden_dim_dec', type=int, default=512, help='hidden dimension of en/decoder')
parser.add_argument('--hidden_layers_enc', type=int, default=2, help='number of hidden layers of en/decoder')
parser.add_argument('--hidden_layers_dec', type=int, default=2, help='number of hidden layers of en/decoder')
...
parser.add_argument('--zs_kl_weight', type=float, default=0.001, help='num of encoder layers')
...
parser.add_argument('--online_adjust', type=float, default=0, help='latent dimension of koopman embedding')
parser.add_argument('--offline_adjust', type=float, default=0, help='latent dimension of koopman embedding')
